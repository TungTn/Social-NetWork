<template>
  <div>
    <div class="container">
      <div class="row">
        <div class="col-md-6"   v-for="company in companies" :key="company.objectID" :id="company.objectID">
            ...
            <div class="col-md-8">
              <div class="details text-left"> 
                ...
                <div class="inline">
                  ...
                  <router-link :to="{name: 'Detail', params: { companyid: company.objectID },}"> Read More </router-link>
                </div>
              </div>
            </div>
          </div>
